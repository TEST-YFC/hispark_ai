...
/**
* @if Eng
* @brief  Obtain all label tensor handles of a train model.
* @param  [in]  model                    Model object handle.
* @retval MSTensorHandleArray Object     Success.
* @retval NULL                           Nullptr Failed.
* @else
* @brief  获取训练模型的标签张量对象列表。
* @param  [in]  model                    模型对象。
* @retval MSTensorHandleArray对象        成功返回#MSTensorHandleArray对象列表。
* @retval NULL                           失败返回#空指针。
* @endif
*/
MS_API MSTensorHandleArray MSModelGetLabels(const MSModelHandle model);

/**
* @if Eng
* @brief  Run one train model step.
* @param  [in]  model                    Model object handle.
* @param  [in]  before                   CallBack before execution.
* @param  [in]  after                    CallBack after execution.
* @retval kMSStatusSuccess               Success.
* @retval other                          Failed.
* @else
* @brief  执行一次训练模型步骤。
* @param  [in]  model                    模型对象。
* @param  [in]  before                   执行前的回调函数。
* @param  [in]  after                    执行后的回调函数。
* @retval kMSStatusSuccess               成功返回#kMSStatusSuccess状态。
* @retval 其他                           失败返回#其他状态码。
* @endif
*/
...
/**
* @if Eng
* @brief  Set train model run step mode.
* @param  [in]  model                    Model object handle.
* @param  [in]  train                    true for train, false for eval.
* @retval kMSStatusSuccess               Success.
* @retval other                          Failed.
* @else
* @brief  设置训练模型的RunStep模式。
* @param  [in]  model                    模型对象。
* @param  [in]  train                    true表示训练，false表示评估。
* @retval kMSStatusSuccess               成功返回#kMSStatusSuccess状态。
* @retval 其他                           失败返回#其他状态码。
* @endif
*/
...
* @param  [in]  model                    Model object handle.
* @retval true                           Train mode.
* @retval false                          Eval mode or failed.
* @else
* @brief  获取模型运行模式。
* @param  [in]  model                    模型对象。
* @retval true                           训练模式。
* @retval false                          评估模式或失败。
* @endif
*/
...
/**
* @if Eng
* @brief  Load train weights from an external continuous weight buffer.
* @param  [in]  model                    Model object handle.
* @param  [in]  weight_buffer            Start address of weights. NULL means default weights.
* @retval kMSStatusSuccess               Success.
* @retval other                          Failed.
* @else
* @brief  从外部连续权重缓冲加载训练权重。
* @param  [in]  model                    模型对象。
* @param  [in]  weight_buffer            权重起始地址，NULL表示默认权重。
* @retval kMSStatusSuccess               成功返回#kMSStatusSuccess状态。
* @retval 其他                           失败返回#其他状态码。
* @endif
*/
MS_API MSStatus MSModelLoadWeight(MSModelHandle model, const void *weight_buffer);
