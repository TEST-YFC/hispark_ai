...
def download_dataset(orig_path: str, save_path: str, train: bool, download_bin: bool, download_npy: bool,
                     bin_datatype: str, max_count: int = 0):
    ...
    Args:
        ...
        max_count: Maximum number of samples to export. 0 means exporting all samples.
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_count',
        help='The number of training samples to export for calibration.',
        default=50,
        type=int,
        required=False
    )
