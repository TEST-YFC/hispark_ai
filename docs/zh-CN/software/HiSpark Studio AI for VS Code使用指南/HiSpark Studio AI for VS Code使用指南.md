...
-   功能介绍
    ...
    HiSpark Studio AI功能架构如[图2.1](#fig1357355818812)所示。具备核心功能有：
    ...
    **图 2.1**  HiSpark Studio AI 功能架构<a name="fig1357355818812"></a>  
...
HiSpark Studio AI整体窗口如[图2.2](#fig141565497718)所示，主要包含两个部分：

1.  侧边栏：HiSpark Studio AI功能导航栏。
2.  工作区：HiSpark Studio AI工作区。

**图 2.2**  HiSpark Studio AI整体窗口<a name="fig141565497718"></a>  
...
**图 2.3**  HiSpark Studio AI核心工作区示意图<a name="fig2478146179"></a>  
...
-   分类任务真值存储为csv格式。包含两列sample和label，其中sample表示样本的名称，和npy文件名保持一致。label表示标签值。csv文件示例见[表2.1](#table55542586239)。
...
单击HiSpark Studio AI插件中的“Home”按钮，进入首页如[图4.1](#fig43390675013)所示。

**图 4.1**  HiSpark Studio AI首页<a name="fig43390675013"></a>  
...
**图 4.2**  HiSpark Studio AI新建工程配置界面<a name="fig19934131663619"></a>  
![](figures/HiSpark-Studio-AI新建工程配置界面.png "HiSpark-Studio-AI新建工程配置界面")

新建工程导入页面的具体逻辑如下，参数详细配置如[表4.1](#table1769074411309)所示。
...
**图 4.3**  模型导入整体页面<a name="fig15594115103619"></a>  
![](figures/模型导入整体页面.png "模型导入整体页面")

模型导入的界面如[图4.3](#fig15594115103619)所示。主要包含以下部分：
...
**图 4.4**  Linux服务器连接选项页面<a name="fig143981083427"></a>  
...
**图 4.5**  模型量化示意图<a name="fig156191537102517"></a>  
![](figures/模型量化示意图.png "模型量化示意图")

模型压缩界面如[图4.5](#fig156191537102517)所示，整体界面主要包含四个部分：
...
3.  <a name="li434033051115"></a>单击“Next”进入下一步，单击删除按钮删除该条记录。

#### 量化参数配置页面<a name="ZH-CN_TOPIC_0000002548383199"></a>

**图 4.6**  模型量化参数配置界面<a name="fig66893348297"></a>  
![](figures/模型量化参数配置界面.png "模型量化参数配置界面")

参数解释如[表4.2](#table1769074411309)所示。
...
<td class="cellrowborder" valign="top" width="73.77%" headers="mcps1.2.3.1.2 "><p id="p11588184515918"><a name="p11588184515918"></a><a name="p11588184515918"></a>使能验证开关。当开关打开时，验证数据集输入界面展开，如<a href="#fig125691159182914">图4.8</a>所示。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="73.77%" headers="mcps1.2.3.1.2 "><p id="p16676134871019"><a name="p16676134871019"></a><a name="p16676134871019"></a>用户在该表格中输入量化评估网络的验证数据集。表格中各列的含义如<a href="#fig125691159182914">图4.8</a>所示：</p>
...
<td class="cellrowborder" valign="top" width="73.77%" headers="mcps1.2.3.1.2 "><p id="p4519123583915"><a name="p4519123583915"></a><a name="p4519123583915"></a>使能开关打开后，输入含分类真值标签的csv表格文件。文件中的表格格式如<a href="#table112929412576">表4.3</a>所示。各列的含义如下所示：</p>
...
**图 4.7**  跳过量化按钮<a name="fig132176591794"></a>  
![](figures/跳过量化按钮.png "跳过量化按钮")

单击“Next Without Quantization”按钮，即可跳过量化步骤，直接转换成浮点模型。

**图 4.8**  验证数据输入页面<a name="fig125691159182914"></a>  
![](figures/验证数据输入页面.png "验证数据输入页面")

Validation Labels输入csv格式如[表4.3](#table112929412576)所示。
...
>![](public_sys-resources/icon-note.gif) **说明：** 
>label.csv中为样本分类的真值标签。文件中的表格格式如[表4.3](#table112929412576)所示。其中sample列表示样本的名称，label列表示样本对应的真值标签。

#### 量化历史配置界面<a name="ZH-CN_TOPIC_0000002516703396"></a>

量化历史显示窗口如[图4.9](#fig16878619143716)所示。

**图 4.9**  量化历史配置页面<a name="fig16878619143716"></a>  
![](figures/量化历史配置页面.png "量化历史配置页面")

该窗口以表格的方式显示历史量化的结果。表头解释如[表4.4](#table17914154610556)所示。
...
验证集精度分布直方图显示窗口如[图4.10](#fig125132017185218)所示，该窗口显示验证集的余弦相似度的分布图。横轴为余弦相似度，纵轴为验证集样本的百分比。

**图 4.10**  验证集精度分布直方图显示界面<a name="fig125132017185218"></a>  
...
**图 4.11**  模型转换整体界面<a name="fig57907974019"></a>  
![](figures/模型转换整体界面.png "模型转换整体界面")

模型转换整体界面如[图4.11](#fig57907974019)所示，主要包含四个部分：
...
3.  单击“Next”进入下一步，单击删除按钮删除该条记录。

#### 转换参数配置页面<a name="ZH-CN_TOPIC_0000002516898192"></a>

**图 4.12**  转换参数配置页面<a name="fig487341125020"></a>  
![](figures/转换参数配置页面.png "转换参数配置页面")

参数说明如[表4.5](#table1769074411309)所示。
...
**图 4.13**  历史转换结果配置界面<a name="fig172891046191311"></a>  
![](figures/历史转换结果配置界面.png "历史转换结果配置界面")

该窗口以表格的方式显示历史转换的结果。表头说明如[表4.6](#table17914154610556)所示。
...
**图 4.14**  AI上板各存储占用分布<a name="fig205537152214"></a>  
![](figures/AI上板各存储占用分布.png "AI上板各存储占用分布")

AI上板存储占比如[图4.14](#fig205537152214)所示，蓝色显示为RAM占用，绿色显示为FLASH占用，各参数显示具体含义如[表4.7](#table17914154610556)所示。
...
**图 4.15**  模型部署页面<a name="fig5293115453112"></a>  
![](figures/模型部署页面.png "模型部署页面")

模型部署整体界面如[图4.15](#fig5293115453112)所示，主要包含四个部分：
...
**图 4.16**  WS63模型调优整体页面<a name="fig89471319155115"></a>  
![](figures/WS63模型调优整体页面.png "WS63模型调优整体页面")

模型调优界面如[图4.16](#fig89471319155115)所示，主要包含五个部分：
...
**图 4.17**  性能验证选项配置<a name="fig995816154011"></a>  
![](figures/性能验证选项配置.png "性能验证选项配置")

参数解释如[表4.8](#table1769074411309)所示。
...
**图 4.18**  性能验证结果页面<a name="fig079215513611"></a>  
![](figures/性能验证结果页面.png "性能验证结果页面")

具体每个参数含义如[表4.9](#table1769074411309)所示。
...
**图 4.19**  上板精度验证配置页面<a name="fig19579133791213"></a>  
![](figures/上板精度验证配置页面.png "上板精度验证配置页面")

参数解释如[表4.10](#table1769074411309)所示。
...
各参数如[表4.11](#table1769074411309)所示。
...
**图 4.20**  上板精度验证准确率信息<a name="fig1940433918178"></a>  
![](figures/上板精度验证准确率信息.png "上板精度验证准确率信息")

**图 4.21**  上板精度验证逐项结果展示<a name="fig131353914188"></a>  
![](figures/上板精度验证逐项结果展示.png "上板精度验证逐项结果展示")

**图 4.22**  上板精度验证余弦相似度分布直方图<a name="fig12558337151812"></a>  
![](figures/上板精度验证余弦相似度分布直方图.png "上板精度验证余弦相似度分布直方图")

#### 评估结果汇总页面<a name="ZH-CN_TOPIC_0000002562010663"></a>

单击“Summary of Results”按钮之后弹出评估结果汇总界面，该界面汇总每次评估的结果。如[图4.23](#fig495923816254)所示。

**图 4.23**  评估结果汇总界面<a name="fig495923816254"></a>  
![](figures/评估结果汇总界面.png "评估结果汇总界面")

评估结果汇总界面元素说明如[表4.12](#table126871262713)所示。
...
1.  在“Deploy”页面下载转换好的Micro工程文件。
    ...
    **图 4.24**  下载micro工程文件<a name="fig6785143417386"></a>  
...
进入HiSpark Studio AI单击“New Project”按钮进入新建工程页面。工程创建整体界面如[图5.1](#fig56341651183719)所示。

**图 5.1**  工程创建整体界面<a name="fig56341651183719"></a>  
...
工程创建界面元素说明如[表5.1](#table10967339113911)所示。
...
模型导入界面整体界面如[图5.2](#fig634318418485)所示。

**图 5.2**  模型导入界面<a name="fig634318418485"></a>  

![](figures/zh-cn_image_0000002532171656.png)

模型导入界面主要元素说明如[表5.2](#table31132274497)。
...
<td class="cellrowborder" valign="top" width="72.89%" headers="mcps1.2.3.1.2 "><p id="p1799119185019"><a name="p1799119185019"></a><a name="p1799119185019"></a>模型导入历史列表。单击“Next”按钮进入对应历史模型的模型压缩界面，单击删除按钮删除该条记录。</p>
</td>
</tr>
</tbody>
</table>
...
**图 5.3**  量化整体界面<a name="fig16918198146"></a>  

![](figures/zh-cn_image_0000002562049207.png)

模型量化整体界面如[图5.3](#fig16918198146)所示，主要包含三个部分：
...
5.  压缩历史显示界面中选择待转换的量化模型，单击“Next”按钮进入模型转换界面，单击删除按钮删除该条记录。
...
**图 5.4**  训练后量化参数配置界面<a name="fig157591121132916"></a>  

![](figures/zh-cn_image_0000002531848386.png)

参数解释如[表5.3](#table1769074411309)所示。
...
**图 5.5**  逐层量化类型配置界面<a name="fig9513147163811"></a>  
![](figures/逐层量化类型配置界面.png "逐层量化类型配置界面")

**图 5.6**  验证集输入界面<a name="fig11646193615123"></a>  
![](figures/验证集输入界面.png "验证集输入界面")

**图 5.7**  高级模式界面<a name="fig232314275455"></a>  
![](figures/高级模式界面.png "高级模式界面")

##### 量化感知训练<a name="ZH-CN_TOPIC_0000002547515395"></a>

量化感知训练参数配置窗口如[图5.8](#fig189812612211)所示。

**图 5.8**  量化感知训练参数配置界面<a name="fig189812612211"></a>  
![](figures/量化感知训练参数配置界面.png "量化感知训练参数配置界面")

参数解释如[表5.4](#table1769074411309)所示。

**表 5.4**  量化感知训练参数配置界面参数
...
**图 5.9**  量化感知训练逐层量化类型配置界面<a name="fig89361036161014"></a>  
![](figures/量化感知训练逐层量化类型配置界面.png "量化感知训练逐层量化类型配置界面")

**图 5.10**  高级模式界面<a name="fig57442431416"></a>  
![](figures/高级模式界面-0.png "高级模式界面-0")

#### 压缩历史显示界面<a name="ZH-CN_TOPIC_0000002515955566"></a>

压缩历史显示窗口如[图5.11](#fig17766212211)所示。

**图 5.11**  压缩历史显示界面<a name="fig17766212211"></a>  
![](figures/压缩历史显示界面.png "压缩历史显示界面")

该界面以表格的方式显示历史压缩的结果。表头解释如[表5.5](#table17914154610556)所示。
...
**图 5.12**  验证集精度分布直方图显示界面<a name="fig125132017185218"></a>  
...
**图 5.13**  模型转换整体界面<a name="fig191831926161420"></a>  
![](figures/模型转换整体界面-2.png "模型转换整体界面-2")

用户在模型转换界面将模型转换成昇腾NPU执行的离线模型。模型转换整体界面如[图5.13](#fig191831926161420)所示。主要包含三个部分：
...
5.  转换历史显示界面选择待评估的模型，单击“Next”按钮进入部署界面，单击删除按钮删除该条记录。

### 模型转换参数配置界面<a name="ZH-CN_TOPIC_0000002517088070"></a>

模型转换参数配置界面如[图5.14](#fig03721841143618)所示。

**图 5.14**  模型转换参数配置界面<a name="fig03721841143618"></a>  
![](figures/模型转换参数配置界面.png "模型转换参数配置界面")

参数解释如[表5.6](#table82721173715)所示。
...
转换历史显示界面如[图5.15](#fig26931136531)所示。

**图 5.15**  转换历史显示界面<a name="fig26931136531"></a>  
![](figures/转换历史显示界面.png "转换历史显示界面")

该界面以表格的方式显示历史转换的结果。表头说明如[表5.7](#table14941640115315)所示。
...
转换结果显示界面如[图5.16](#fig1526210123512)所示。该界面以柱状图的形式显示转换后模型以及图调试信息文件的大小。

**图 5.16**  转换结果显示界面<a name="fig1526210123512"></a>  
![](figures/转换结果显示界面.png "转换结果显示界面")

## 部署<a name="ZH-CN_TOPIC_0000002541425345"></a>

部署界面如[图5.17](#fig789910546818)所示。

**图 5.17**  部署界面<a name="fig789910546818"></a>  
![](figures/部署界面.png "部署界面")

该界面主要包含Model currently selected、Build and Burn、Download Results三个部分。Build and Burn中的主要控件如[表5.8 Build and Burn主要控件说明](#table105181481495)所示。

**表 5.8**  Build and Burn主要控件说明
...
**图 5.18**  模型调优整体界面<a name="fig825954753619"></a>  
![](figures/模型调优整体界面.png "模型调优整体界面")

模型调优整体界面如[图5.18](#fig825954753619)所示，主要包含四个部分：
...
用户在串口配置界面配置数据传输、命令发送串口和波特率。串口配置界面如[图5.19](#fig1637415227426)所示。

**图 5.19**  串口配置界面<a name="fig1637415227426"></a>  
![](figures/串口配置界面.png "串口配置界面")

元素说明如[表5.10](#table1315143434513)所示。
...
<tr id="row12755194814613"><td class="cellrowborder" valign="top" width="31.1%" headers="mcps1.2.3.1.1 "><p id="p6755154810464"><a name="p6755154810464"></a><a name="p6755154810464"></a>Data Port-&gt;BaudRate</p>
</td>
...
<tr id="row1157026154811"><td class="cellrowborder" valign="top" width="31.1%" headers="mcps1.2.3.1.1 "><p id="p45701963486"><a name="p45701963486"></a><a name="p45701963486"></a>Command Port-&gt;BaudRate</p>
</td>
...
用户在性能评估界面触发上板性能评估，并查看性能评估结果。性能评估界面的如[图5.20](#fig168883129411)所示。

**图 5.20**  性能评估界面<a name="fig168883129411"></a>  
![](figures/性能评估界面.png "性能评估界面")

性能评估界面元素说明如[表5.11](#table8147195912415)所示。
...
用户在精度评估界面配置精度评估验证数据、触发上板精度验证以及查看精度验证结果。精度评估界面如[图5.21](#fig29194371693)所示。

**图 5.21**  精度评估界面<a name="fig29194371693"></a>  
![](figures/精度评估界面.png "精度评估界面")

精度评估界面元素说明如[表5.12](#table14641101316114)所示。
...
<td class="cellrowborder" valign="top" width="70.02000000000001%" headers="mcps1.2.3.1.2 "><p id="p956715576197"><a name="p956715576197"></a><a name="p956715576197"></a>各验证样本验证结果。表格中各项说明如<a href="#table8115238122018">表5.13</a>所示。</p>
</td>
</tr>
...
单击“Summary of Results”按钮之后弹出评估结果汇总界面，该界面汇总每次评估的结果。如[图5.22](#fig15398321925)所示。

**图 5.22**  评估结果汇总界面<a name="fig15398321925"></a>  
![](figures/评估结果汇总界面-3.png "评估结果汇总界面-3")

评估结果汇总界面元素说明如[表5.14](#table126871262713)所示。
...
1.  在Deploy页面下载转换好的exeom模型。
    ...
    **图 5.23**  下载exeom模型<a name="fig126011912721"></a>  
